        ...
        <div className="hidden md:flex items-center space-x-8">
          {navLinks.map((link) => (
            <button
              ...
              className={`text-sm font-bold uppercase tracking-widest transition-colors duration-300 ${currentView === link.id
                ? 'text-nex-blue'
          ...
          <div className="flex flex-col p-4 space-y-4">
            {navLinks.map((link) => (
              <button
                ...
                className={`text-left font-bold uppercase tracking-widest ${currentView === link.id ? 'text-nex-blue' : 'text-nex-dark'
                  }`}
              >
                {link.label}
              </button>
